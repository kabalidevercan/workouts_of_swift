...
struct CoverFlowUI<Content:View,Item:RandomAccessCollection>: View where Item.Element : Identifiable {
                    ...
                    GeometryReader{
                        ...
                        self
                            ...
                            .mask{
                                Rectangle()
                                    .fill(
                                        .linearGradient(colors: [.white,.white.opacity(0.7),.white.opacity(0.5),.white.opacity(0.3),.white.opacity(0.1),.white.opacity(0)] + Array(repeating: Color.clear, count: 5), startPoint: .top, endPoint: .bottom)
                                    )
                            }
                            ///Moving to Bottom
